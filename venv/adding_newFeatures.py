...
def main_gui():
    ...
    filemenu.add_command(label="New Data", command=onclick_main_add)
    filemenu.add_command(label="Update Data", command=onclick_main_update)
    filemenu.add_command(label="Delete", command=onclick_main_delete)
    filemenu.add_command(label="Review Data", command=onclick_main_view)
    #filemenu.add_command(label="Close")

    filemenu.add_separator()

    filemenu.add_command(label="Exit", command=exit_main_window)
